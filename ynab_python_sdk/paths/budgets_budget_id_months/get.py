...
from ynab_python_sdk.model.month_summaries_response import MonthSummariesResponse as MonthSummariesResponseSchema
...
from ynab_python_sdk.type.month_summaries_response import MonthSummariesResponse

from ...api_client import Dictionary
from ynab_python_sdk.pydantic.month_summaries_response import MonthSummariesResponse as MonthSummariesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MonthSummariesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MonthSummariesResponse
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/budgets/{budget_id}/months',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MonthSummariesResponsePydantic:
        ...
        if validate:
            return MonthSummariesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MonthSummariesResponsePydantic, raw_response.body)
