...
from ynab_python_sdk.model.categories_response import CategoriesResponse as CategoriesResponseSchema
from ynab_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from ynab_python_sdk.type.categories_response import CategoriesResponse
from ynab_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from ynab_python_sdk.pydantic.categories_response import CategoriesResponse as CategoriesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CategoriesResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_by_budget_id_mapped_args(
        self,
        budget_id: str,
    ...
    async def _alist_by_budget_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/budgets/{budget_id}/categories',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByBudgetIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_by_budget_id(
        self,
        budget_id: str,
        last_knowledge_of_server: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_by_budget_id_mapped_args(
            budget_id=budget_id,
            last_knowledge_of_server=last_knowledge_of_server,
        )
        return await self._alist_by_budget_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_by_budget_id(
        self,
        budget_id: str,
        last_knowledge_of_server: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        return self._list_by_budget_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByBudgetId(BaseApi):
    ...
    async def alist_by_budget_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CategoriesResponsePydantic:
        raw_response = await self.raw.alist_by_budget_id(
            budget_id=budget_id,
            last_knowledge_of_server=last_knowledge_of_server,
            **kwargs,
        )
        if validate:
            return CategoriesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CategoriesResponsePydantic, raw_response.body)
    ...
    def list_by_budget_id(
        ...
        raw_response = self.raw.list_by_budget_id(
            budget_id=budget_id,
            last_knowledge_of_server=last_knowledge_of_server,
        )
        if validate:
