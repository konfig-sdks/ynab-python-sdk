...
class BaseApi(api_client.Api):
    ...
    def _get_single_account_mapped_args(
        self,
        budget_id: str,
        account_id: str,
    ...
    async def _aget_single_account_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/budgets/{budget_id}/accounts/{account_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetSingleAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_account(
        self,
        budget_id: str,
        account_id: str,
        **kwargs,
        ...
        args = self._get_single_account_mapped_args(
            budget_id=budget_id,
            account_id=account_id,
        )
        return await self._aget_single_account_oapg(
    ...
    def get_single_account(
        ...
        return self._get_single_account_oapg(
            path_params=args.path,
        )

class GetSingleAccount(BaseApi):
    ...
    async def aget_single_account(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_account(
            budget_id=budget_id,
            account_id=account_id,
            **kwargs,
        )
    ...
    def get_single_account(
        ...
        raw_response = self.raw.get_single_account(
            budget_id=budget_id,
            account_id=account_id,
        )
        if validate:
