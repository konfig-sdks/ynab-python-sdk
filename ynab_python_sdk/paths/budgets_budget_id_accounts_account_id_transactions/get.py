...
from ynab_python_sdk.model.transactions_response import TransactionsResponse as TransactionsResponseSchema
from ynab_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from ynab_python_sdk.type.transactions_response import TransactionsResponse
...
from ynab_python_sdk.pydantic.transactions_response import TransactionsResponse as TransactionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TransactionsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_by_account_mapped_args(
        self,
        budget_id: str,
        account_id: str,
    ...
    async def _alist_by_account_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/budgets/{budget_id}/accounts/{account_id}/transactions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_by_account(
        self,
        budget_id: str,
        account_id: str,
        since_date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._list_by_account_mapped_args(
            budget_id=budget_id,
        ...
        return await self._alist_by_account_oapg(
    ...
    def list_by_account(
        ...
        return self._list_by_account_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByAccount(BaseApi):
    ...
    async def alist_by_account(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransactionsResponsePydantic:
        raw_response = await self.raw.alist_by_account(
            budget_id=budget_id,
            account_id=account_id,
            since_date=since_date,
            type=type,
        ...
        if validate:
            return TransactionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TransactionsResponsePydantic, raw_response.body)
    ...
    def list_by_account(
        ...
        raw_response = self.raw.list_by_account(
            budget_id=budget_id,
            account_id=account_id,
            since_date=since_date,
            type=type,
