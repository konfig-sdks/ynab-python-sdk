...
from ynab_python_sdk.model.category_response import CategoryResponse as CategoryResponseSchema
...
from ynab_python_sdk.type.category_response import CategoryResponse

from ...api_client import Dictionary
from ynab_python_sdk.pydantic.category_response import CategoryResponse as CategoryResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CategoryResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_month_category_by_id_mapped_args(
        self,
        budget_id: str,
        month: date,
        category_id: str,
    ...
    async def _aget_month_category_by_id_oapg(
        self,
    ...
    def _get_month_category_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMonthCategoryByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_month_category_by_id(
        self,
        budget_id: str,
        month: date,
        category_id: str,
        **kwargs,
        ...
        args = self._get_month_category_by_id_mapped_args(
            budget_id=budget_id,
            month=month,
            category_id=category_id,
        )
        return await self._aget_month_category_by_id_oapg(
    ...
    def get_month_category_by_id(
        ...
        return self._get_month_category_by_id_oapg(
            path_params=args.path,
        )

class GetMonthCategoryById(BaseApi):
    ...
    async def aget_month_category_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CategoryResponsePydantic:
        raw_response = await self.raw.aget_month_category_by_id(
            budget_id=budget_id,
            month=month,
            category_id=category_id,
            **kwargs,
        ...
        if validate:
            return CategoryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CategoryResponsePydantic, raw_response.body)
    ...
    def get_month_category_by_id(
        ...
        raw_response = self.raw.get_month_category_by_id(
            budget_id=budget_id,
            month=month,
            category_id=category_id,
        )
