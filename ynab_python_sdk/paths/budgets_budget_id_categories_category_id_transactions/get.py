...
from ynab_python_sdk.model.hybrid_transactions_response import HybridTransactionsResponse as HybridTransactionsResponseSchema
from ynab_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from ynab_python_sdk.type.hybrid_transactions_response import HybridTransactionsResponse
from ynab_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from ynab_python_sdk.pydantic.hybrid_transactions_response import HybridTransactionsResponse as HybridTransactionsResponsePydantic
from ynab_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic

from . import path

# Query params
SinceDateSchema = schemas.DateSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'since_date': typing.Union[SinceDateSchema, str, date, ],
...
request_query_since_date = api_client.QueryParameter(
    name="since_date",
    style=api_client.ParameterStyle.FORM,
    schema=SinceDateSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = HybridTransactionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: HybridTransactionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_by_category_mapped_args(
        self,
        budget_id: str,
        category_id: str,
        since_date: typing.Optional[date] = None,
        ...
        if since_date is not None:
            _query_params["since_date"] = since_date
        if type is not None:
    ...
    async def _alist_by_category_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/budgets/{budget_id}/categories/{category_id}/transactions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByCategoryRaw(BaseApi):
    ...
    async def alist_by_category(
        ...
        **kwargs,
        ...
        args = self._list_by_category_mapped_args(
            budget_id=budget_id,
        ...
        return await self._alist_by_category_oapg(
    ...
    def list_by_category(
        ...
        return self._list_by_category_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByCategory(BaseApi):
    ...
    async def alist_by_category(
        ...
        validate: bool = False,
        **kwargs,
    ) -> HybridTransactionsResponsePydantic:
        raw_response = await self.raw.alist_by_category(
            budget_id=budget_id,
            category_id=category_id,
            since_date=since_date,
            type=type,
        ...
        if validate:
            return HybridTransactionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(HybridTransactionsResponsePydantic, raw_response.body)
    ...
    def list_by_category(
        ...
        raw_response = self.raw.list_by_category(
            budget_id=budget_id,
            category_id=category_id,
            since_date=since_date,
            type=type,
