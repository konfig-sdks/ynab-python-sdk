...
class BaseApi(api_client.Api):
    ...
    def _get_single_category_mapped_args(
        self,
        budget_id: str,
        category_id: str,
    ...
    async def _aget_single_category_oapg(
        self,
...
class GetSingleCategoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_category(
        self,
        budget_id: str,
        category_id: str,
        **kwargs,
        ...
        args = self._get_single_category_mapped_args(
            budget_id=budget_id,
            category_id=category_id,
        )
        return await self._aget_single_category_oapg(
    ...
    def get_single_category(
        ...
        return self._get_single_category_oapg(
            path_params=args.path,
        )

class GetSingleCategory(BaseApi):
    ...
    async def aget_single_category(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_category(
            budget_id=budget_id,
            category_id=category_id,
            **kwargs,
        )
    ...
    def get_single_category(
        ...
        raw_response = self.raw.get_single_category(
            budget_id=budget_id,
            category_id=category_id,
        )
        if validate:
