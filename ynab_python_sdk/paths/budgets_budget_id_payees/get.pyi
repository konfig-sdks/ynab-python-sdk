...
from ynab_python_sdk.model.payees_response import PayeesResponse as PayeesResponseSchema
from ynab_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from ynab_python_sdk.type.payees_response import PayeesResponse
...
from ynab_python_sdk.pydantic.payees_response import PayeesResponse as PayeesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PayeesResponseSchema
    ...
    async def _alist_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/budgets/{budget_id}/payees',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return PayeesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PayeesResponsePydantic, raw_response.body)
