...
from ynab_python_sdk.model.patch_transactions_wrapper import PatchTransactionsWrapper as PatchTransactionsWrapperSchema
from ynab_python_sdk.model.save_transaction_with_id_or_import_id import SaveTransactionWithIdOrImportId as SaveTransactionWithIdOrImportIdSchema
...
from ynab_python_sdk.type.patch_transactions_wrapper import PatchTransactionsWrapper
from ynab_python_sdk.type.error_response import ErrorResponse
from ynab_python_sdk.type.save_transaction_with_id_or_import_id import SaveTransactionWithIdOrImportId

from ...api_client import Dictionary
from ynab_python_sdk.pydantic.save_transaction_with_id_or_import_id import SaveTransactionWithIdOrImportId as SaveTransactionWithIdOrImportIdPydantic
from ynab_python_sdk.pydantic.patch_transactions_wrapper import PatchTransactionsWrapper as PatchTransactionsWrapperPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PatchTransactionsWrapperSchema
...
SchemaFor209ResponseBodyApplicationJson = SaveTransactionsResponseSchema


@dataclass
class ApiResponseFor209(api_client.ApiResponse):
    body: SaveTransactionsResponse


@dataclass
class ApiResponseFor209Async(api_client.AsyncApiResponse):
    body: SaveTransactionsResponse


_response_for_209 = api_client.OpenApiResponse(
    response_cls=ApiResponseFor209,
    response_cls_async=ApiResponseFor209Async,
    content={
        'application/json': api_client.MediaType(
            schema=SchemaFor209ResponseBodyApplicationJson),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _update_multiple_mapped_args(
        self,
        transactions: typing.List[SaveTransactionWithIdOrImportId],
        budget_id: str,
