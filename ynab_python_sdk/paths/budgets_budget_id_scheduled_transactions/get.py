...
from ynab_python_sdk.model.scheduled_transactions_response import ScheduledTransactionsResponse as ScheduledTransactionsResponseSchema
from ynab_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from ynab_python_sdk.type.scheduled_transactions_response import ScheduledTransactionsResponse
...
from ynab_python_sdk.pydantic.scheduled_transactions_response import ScheduledTransactionsResponse as ScheduledTransactionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ScheduledTransactionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ScheduledTransactionsResponse
    ...
    async def _alist_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/budgets/{budget_id}/scheduled_transactions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ScheduledTransactionsResponsePydantic:
        ...
        if validate:
            return ScheduledTransactionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ScheduledTransactionsResponsePydantic, raw_response.body)
