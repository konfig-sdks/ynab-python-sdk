...
class CategoryGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "hidden", "deleted", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "hidden", "deleted", ], str]):
