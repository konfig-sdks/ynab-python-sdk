...
class SaveCategoryResponseData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["category", "server_knowledge", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["category"]) -> 'Category': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["category", "server_knowledge", ], str]):
