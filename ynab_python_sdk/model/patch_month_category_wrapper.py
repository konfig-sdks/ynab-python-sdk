...
class PatchMonthCategoryWrapper(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def category() -> typing.Type['SaveMonthCategory']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["category"]) -> 'SaveMonthCategory': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["category"]) -> 'SaveMonthCategory': ...
